...
import type { AuthFetch, CartItem } from '@/types';

export type AddToCartInput = Pick<CartItem, 'product_id' | 'name' | 'price'> &
  Partial<Pick<CartItem, 'id' | 'option_label' | 'color_name' | 'quantity' | 'image_url' | 'slug'>>;
