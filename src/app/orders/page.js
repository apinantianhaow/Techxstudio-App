  ...
  if (!authLoading && !isLoggedIn) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-4 space-y-4">
        <Breadcrumbs items={[{ label: 'คำสั่งซื้อ' }]} />
        <div className="text-center py-20 space-y-4">
          <Package className="w-20 h-20 mx-auto text-surface-300 dark:text-surface-600" />
          <h2 className="text-xl font-bold text-surface-700 dark:text-surface-300">กรุณาเข้าสู่ระบบ</h2>
          <p className="text-sm text-surface-400">เข้าสู่ระบบเพื่อดูคำสั่งซื้อของคุณ</p>
          <Link href="/account">
    ...
    <div className="max-w-4xl mx-auto px-4 py-4 space-y-4">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 space-y-4">
          ...
          <p className="text-surface-400">ยังไม่มีคำสั่งซื้อ</p>
          <Link href="/">
            ...
            >
              ...
              <div className="p-4 border-b border-surface-200 dark:border-surface-700">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <p className="text-[10px] text-surface-400">หมายเลขสั่งซื้อ</p>
              ...
              <div className="px-4 py-3 bg-surface-50 dark:bg-surface-900/50 flex items-center justify-between">
                {order.discount_amount > 0 && (
                  <span className="text-[10px] text-success">ส่วนลด -{formatPrice(order.discount_amount)}</span>
                )}
                <div className="ml-auto text-right">
                  <p className="text-[10px] text-surface-400">ยอดชำระ</p>
