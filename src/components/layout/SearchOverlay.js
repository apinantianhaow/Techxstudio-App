      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 right-0 z-[var(--z-modal)] glass-modal rounded-b-2xl p-4 max-h-[80vh] overflow-y-auto"
          >
            {/* Search input */}
                ...
                {results.map((product) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className="w-14 h-14 rounded-lg bg-surface-100 dark:bg-surface-800 flex items-center justify-center overflow-hidden flex-shrink-0">
                          {firstColor?.image_url ? (
                            <img src={firstColor.image_url} alt={product.name} className="w-full h-full object-contain p-1" />
                          ) : (
                            <div className="w-full h-full gradient-primary opacity-20 rounded-lg" />
                          )}
                        </div>
